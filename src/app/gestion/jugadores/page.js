    ...
    <ContenedorPagina>
      ...
      <header className="mt-4 border-b border-stone-200 pb-6">
        ...
        <p className="mt-2 max-w-2xl text-base text-stone-600">
          Alta de jugadores por club. Luego los sumás al plantel de cada equipo en la
          gestión del torneo.
        </p>
      </header>
      ...
      <section className="mt-10">
        ...
        <ul className="mt-4 space-y-6">
          {(jugadores ?? []).map((j) => (
            ...
            >
              <form action={actualizarJugador} className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="flex items-center gap-2 sm:col-span-2">
                  <input
                    ...
                    className="h-5 w-5"
                  />
                  <label htmlFor={`activo-j-${j.id}`} className="text-sm text-stone-700">
                    Jugador activo
                  </label>
                </div>
                <p className="text-xs text-stone-500 sm:col-span-2">
                  Club actual en listado: {nombreClub(j)}
                </p>
                <div className="sm:col-span-2">
                  <button
                    type="submit"
